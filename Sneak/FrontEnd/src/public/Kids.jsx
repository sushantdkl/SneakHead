...
const Kids = () => {
  ...
  const fetchKidsProducts = async () => {
    try {
      setLoading(true);
      const response = await fetch('http://localhost:3000/api/products?category=kids');
      if (response.ok) {
  ...
  return (
    <div className="min-h-screen bg-sneakhead-black text-white">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-900/20 via-sneakhead-gray to-green-900/20 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-black font-grotesk mb-4">
            KIDS' <span className="text-sneakhead-red">COLLECTION</span>
          </h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Fun and comfortable sneakers for active kids of all ages
          </p>
        </div>
      </div>
